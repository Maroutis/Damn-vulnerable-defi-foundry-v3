...
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626 {
    ...
    function flashLoan(
        ...
        if (convertToShares(totalSupply) != balanceBefore) revert InvalidBalance(); // enforce ERC4626 requirement //@audit totalSupply is the supply if vault tokens doesnt make sens to convert it to vault tokens
